...
const getCurrentSkin = function() {
    ...
    for(let i = 0; i < total; i++){
        ...
        } else el[i].removeAttribute("selected");
    }
    return {
        name: skin,
        params: skins[skin]
    ...
    stories: [
        {
            ...
            name: `Dicas de <br> Reda\xe7\xe3o`,
            time: 1710243788,
            items: [
                {
...
$(window).on("resize", function() {
    ...
    if (width > 1200) // Verifica se o slider já foi inicializado
    {
        if ($(".auloes__container").hasClass("slick-initialized")) // Destrói o slider
        $(".auloes__container").slick("unslick");
    } else // Re-inicializa o slider se a tela for menor que 1200px
    // e o slider ainda não foi inicializado
    if (!$(".auloes__container").hasClass("slick-initialized")) $(".auloes__container").slick({
        slidesToShow: 8,
        unslick: true,
        autoplay: true,
        mobileFirst: true,
...
$(document).ready(function() {
    var width = $(window).width();
    if (width <= 1200) $(".seu-slider").slick({
        slidesToShow: 8,
        unslick: true,
        autoplay: true,
        mobileFirst: true,
...
},{}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequirec618")
